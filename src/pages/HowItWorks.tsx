            ...
            {processSteps.map((step, index) => (
              <div key={index} className="text-center">
                <div className="relative inline-block mb-6">
                  <div className="w-6 h-6 bg-rose-gold text-white rounded-full flex items-center justify-center text-xs font-light absolute -top-1 -right-1">
                    {step.number}
                  </div>
                  <div className="w-12 h-12 bg-soft-pink rounded-full flex items-center justify-center text-rose-gold">
                    {step.icon}
                  </div>
                </div>
