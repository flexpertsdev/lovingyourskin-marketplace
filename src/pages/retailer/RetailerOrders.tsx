...
export const RetailerOrders: React.FC = () => {
  ...
  const loadOrders = async () => {
    ...
    try {
      ...
      // Filter for orders placed by this retailer
      ...
      <Section>
        <Container>
          <div className="flex justify-between items-center mb-8">
            <div>
              <h1 className="text-3xl font-light">My B2B Orders</h1>
              <p className="text-text-secondary mt-2">Track and manage your wholesale orders</p>
            </div>
                  ...
                  <CardContent>
                    <div className="flex justify-between items-start">
                      <div className="flex-1">
                        ...
                        <p className="text-lg mb-1 font-medium">{order.brandName}</p>
